...
# 创建路由装饰器
router=Blueprint("youqinglianjie")
...
def insert(request):
    ...
    # 获取提交的数据
    data = {
        'wangzhanmingcheng': utils.param('wangzhanmingcheng',''),
        'wangzhi': utils.param('wangzhi',''),
...
def update(request):
    ...
    data = {
        'id': charuid,
        'wangzhanmingcheng': utils.param('wangzhanmingcheng',old.wangzhanmingcheng),
        'wangzhi': utils.param('wangzhi',old.wangzhi),
