<template>
    <div class="views-kechengziyuan-updt">
        <div>
...
<script setup>
    ...
    import { useKechengziyuanFindById, canKechengziyuanFindById, canKechengziyuanUpdate, canKechengxinxiFindById } from "@/module";
    ...
    const form = useKechengziyuanFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canKechengziyuanUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
