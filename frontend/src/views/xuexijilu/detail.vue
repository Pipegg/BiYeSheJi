<template>
    <div class="views-xuexijilu-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 学习记录详情 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useXuexijiluFindById, canXuexijiluFindById } from "@/module";
    ...
    const map = useXuexijiluFindById(props.id);
