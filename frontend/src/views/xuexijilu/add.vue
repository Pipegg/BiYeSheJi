...
<script setup>
    ...
    import { useXuexijiluCreateForm, canXuexijiluInsert } from "@/module";
    ...
    const { form, readMap } = useXuexijiluCreateForm(props.id);
