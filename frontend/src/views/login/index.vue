                    ...
                    <form action="javascript:;" method="post">
                        <ul class="admin_items">
                            ...
                            <li>
                                ...
                                <input type="password" name="pwd" :value="form.pwd" @input="form.pwd = $event.target.value" id="pwd" class="admin_input_style" />
                            </li>
                            <li class="pagerandom">
                            ...
                            <li>
                                <el-button-group>
                                    ...
                                    <el-button 
                                        @click="form.cx = r" 
                                        :type="form.cx == r ? 'primary' : 'default'" 
