            ...
            <div class="sidebar-wrap">
                ...
                <div class="sidebar-content">
                    <ul class="sidebar-list" id="sidebarList">
                        <li v-for="(m,k) in menus" :key="k" :class="{active:k==active}">
                            <a href="javascript:;" @click="active=k"><i class="icon-font">&#xe018;</i>{{m.label}}</a>
                            <ul class="sub-menu" v-show="k==active">
                                <li v-for="(v,index) in m.children" :key="index"><router-link :to="v.to">{{v.label}}</router-link></li>
                            </ul>
                        </li>
                    </ul>
                </div>
