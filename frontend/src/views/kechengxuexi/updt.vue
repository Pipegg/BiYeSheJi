<template>
    <div class="views-kechengxuexi-updt">
        <div>
...
<script setup>
    ...
    import { useKechengxuexiFindById, canKechengxuexiFindById, canKechengxuexiUpdate, canKechengxinxiFindById } from "@/module";
    ...
    const form = useKechengxuexiFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canKechengxuexiUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
