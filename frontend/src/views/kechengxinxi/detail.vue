<template>
    <div class="views-kechengxinxi-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 课程信息详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="课程封面"> <e-img :src="map.kechengfengmian" class="detail-image" style="max-width: 120px" /> </el-descriptions-item>
                        <el-descriptions-item label="课程要点"> {{ map.kechengyaodian }} </el-descriptions-item>
                    ...
                    <el-descriptions direction="vertical" class="margin-top" :column="1" border>
                        <el-descriptions-item label="课程详情"> <div v-html="map.kechengxiangqing"></div> </el-descriptions-item>
                    </el-descriptions>
                </div>
...
<script setup>
    ...
    const map = useKechengxinxiFindById(props.id);
