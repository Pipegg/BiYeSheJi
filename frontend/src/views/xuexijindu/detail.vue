<template>
    <div class="views-xuexijindu-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 学习进度详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="更新时间"> {{ map.addtime }} </el-descriptions-item>
                    </el-descriptions>
...
<script setup>
    ...
    import { useXuexijinduFindById, canXuexijinduFindById } from "@/module";
    ...
    const map = useXuexijinduFindById(props.id);
