<template>
    <div class="views-xuexijindu-add">
        <div>
...
<script setup>
    ...
    import { useXuexijinduCreateForm, canXuexijinduInsert } from "@/module";
    ...
    const { form, readMap } = useXuexijinduCreateForm(props.id);
