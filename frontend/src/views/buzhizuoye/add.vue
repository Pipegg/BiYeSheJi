<template>
    <div class="views-buzhizuoye-add">
        <div>
...
<script setup>
    ...
    import { useBuzhizuoyeCreateForm, canBuzhizuoyeInsert } from "@/module";
    ...
    const { form, readMap } = useBuzhizuoyeCreateForm(props.id);
