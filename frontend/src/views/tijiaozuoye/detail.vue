<template>
    <div class="views-tijiaozuoye-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 提交作业详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="学生姓名"> {{ map.xueshengxingming }} </el-descriptions-item>
                        <el-descriptions-item label="作业状态"> {{ map.zuoyezhuangtai }} </el-descriptions-item>
                        <el-descriptions-item label="提交学生"> {{ map.tijiaoxuesheng }} </el-descriptions-item>
...
<script setup>
    ...
    import { useTijiaozuoyeFindById, canTijiaozuoyeFindById } from "@/module";
    ...
    const map = useTijiaozuoyeFindById(props.id);
