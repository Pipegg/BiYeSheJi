<template>
    <div class="views-tijiaozuoye-web-add">
        <div>
            <e-container>
...
<script setup>
    ...
    import { useTijiaozuoyeCreateForm, canTijiaozuoyeInsert } from "@/module";
    ...
    const { form, readMap } = useTijiaozuoyeCreateForm(props.id);
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canTijiaozuoyeInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {
