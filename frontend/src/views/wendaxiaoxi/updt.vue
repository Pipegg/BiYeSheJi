<template>
    <div class="views-wendaxiaoxi-updt">
        <div>
...
<script setup>
    ...
    import { useWendaxiaoxiFindById, canWendaxiaoxiFindById, canWendaxiaoxiUpdate } from "@/module";
    ...
    const form = useWendaxiaoxiFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canWendaxiaoxiUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
