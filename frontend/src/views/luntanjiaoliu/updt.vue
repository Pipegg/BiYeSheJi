<template>
    <div class="views-luntanjiaoliu-updt">
        <div>
...
<script setup>
    ...
    import { useLuntanjiaoliuFindById, canLuntanjiaoliuFindById, canLuntanjiaoliuUpdate } from "@/module";
    ...
    const form = useLuntanjiaoliuFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canLuntanjiaoliuUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
