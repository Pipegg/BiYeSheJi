<template>
    <div class="views-jiaoliuhuifu-updt">
        <div>
...
<script setup>
    ...
    import { useJiaoliuhuifuFindById, canJiaoliuhuifuFindById, canJiaoliuhuifuUpdate, canLuntanjiaoliuFindById } from "@/module";
    ...
    const form = useJiaoliuhuifuFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canJiaoliuhuifuUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
