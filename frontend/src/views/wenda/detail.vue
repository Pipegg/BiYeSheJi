            ...
            <el-card class="box-card">
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        <el-descriptions-item label="提问内容"> {{ map.tiwenneirong }} </el-descriptions-item>
                        <el-descriptions-item label="检索类型"> {{ map.jiansuoleixing }} </el-descriptions-item>
                    </el-descriptions>
...
<script setup>
    ...
    import { useWendaFindById, canWendaFindById } from "@/module";
    ...
    const map = useWendaFindById(props.id);
